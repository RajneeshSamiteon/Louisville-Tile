({
	...
	selectItem : function( component, event, helper ) {
        if(!$A.util.isEmpty(event.currentTarget.id)) {
            ...
            component.set('v.selectedUserId', selectedRecords);
    ...
    blurEvent : function( component, event, helper ){
     ...
     validateCustomLookup : function(component,event,helper){
        let allValid = component.find('inputLookup');
         let isallValid=allValid.get('v.validity');
         var userName=allValid.get('v.value');
         console.log('allValid'+allValid.get('v.value'));
         if(userName ==''){
            allValid.setCustomValidity("Complete this field");
    ...
    fetchUserRecord:function(component,event,helper){
        debugger;
        var selectedRecords=component.get("v.selectedRecords");
        selectedRecords.push(userId);
        component.set("v.selectedRecords",selectedRecords);
        helper.fetchUserRecordone(component,event,helper);
    }
})